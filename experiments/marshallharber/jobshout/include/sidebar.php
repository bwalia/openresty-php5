				...
				<div class="accordion-body collapse" id="collapseSettings">
					<div class="accordion-inner">
						<ul class="nav nav-list">
							...
							<li <?php if($curr_file=="site_settings.php" || $curr_file=="site_setting.php" || $curr_file=="site_option.php") { ?> class="active" <?php }?>><a href="site_settings.php">Settings</a></li>
							...
							<li <?php if($curr_file=="html_help.php") { ?> class="active" <?php }?>><a href="html_help.php">Help for HTML</a></li>
						</ul>
					</div>
				</div>
			</div>
