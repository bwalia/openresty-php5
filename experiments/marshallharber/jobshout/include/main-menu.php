...
<?php
		...
		<nav>
			<div class="nav-collapse">
				<ul class="nav">
					<li class="dropdown">
						<a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon-list-alt icon-white"></i> Dashboard <b class="caret"></b></a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown">
						<a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon-file icon-white"></i> Web Content <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="banners.php">Banners</a></li>
							
							<li><a href="pages.php">Web Pages</a></li>
							<li><a href="categories.php">Web Categories</a></li>
							<li><a href="cat_groups.php">Web Category Groups</a></li>
							<li><a href="pdf_docs.php">PDF Documents</a></li>
							<li><a href="browse_by_categories.php">View Content by Category</a></li>
						</ul>
					</li>
					
					<li class="dropdown">
						<a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon-cog icon-white"></i> Blog Posts <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="blogs.php">Blog Posts</a></li>
							<li><a href="blog_comments.php">Post Comments</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon-th icon-white"></i> Job Board <b class="caret"></b></a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown">
						<a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon-list-alt icon-white"></i> CRM Database <b class="caret"></b></a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown">
						<a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon-cog icon-white"></i> Settings <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="links.php">Bookmarks</a></li>
							<li><a href="components.php">Components</a></li>
							<li><a href="pictures.php">Images</a></li>
							<li><a href="templates.php">Templates</a></li>
							<li><a href="tokens.php">Tokens</a></li>
							<li><a href="videos.php">Videos</a></li>
							<li><a href="locations.php">UK Locations</a></li>
							<li><a href="sites.php">Web Sites</a></li>
