...
if(isset($_POST['submit']))
{
	...
	$db->query("INSERT INTO documents (ID, SiteID, Code, Body, Reference, FFAlpha80_3, FFReal01, FFReal02, FFAlpha80_7, FFAlpha80_6, MetaTagKeywords, MetaTagDescription, UserID, PageTitle, Type, Published_timestamp, GUID, Sync_LastTime, AutoFormatTitle, PostedTimestamp) 
									VALUES(NULL, '".SITE_ID."', '$Code', '$Body', '$reference', '$job_type', '$sal_from', '$sal_to', '$sal_dur', '$location', '$MetaTagKeywords', '$MetaTagDescription', '$UserID', '$PageTitle', '$Type', '$Published_timestamp', '$GUID', 1, '$auto_format', '$Published_timestamp')");
