	...
	<ul>
		...
		<li>
		 ...
		 <?php
					...
					?>
		<li>
			<a href="campaign.php">Add new Campaign</a>
		</li>
		<?php } ?>
					...
					dt_e: function(){
						if($('#dt_e').length) {
							...
							oTable = $('#dt_e').dataTable( {
								<?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['wi_campaigns']) && isset($_SESSION['last_search']['wi_campaigns']['sSearch'])) { ?>
								"oSearch": {"sSearch": "<?php  echo $_SESSION['last_search']['wi_campaigns']['sSearch'];  ?>"},
								<?php } ?>
								"bProcessing": true,
								"bServerSide": true,
								"iDisplayLength": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['wi_campaigns']) && isset($_SESSION['last_search']['wi_campaigns']['iDisplayLength'])) { echo $_SESSION['last_search']['wi_campaigns']['iDisplayLength']; } else { echo '25'; } ?>,
								"iDisplayStart": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['wi_campaigns']) && isset($_SESSION['last_search']['wi_campaigns']['iDisplayStart'])) { echo $_SESSION['last_search']['wi_campaigns']['iDisplayStart']; } else { echo '0'; } ?>,
								...
								"sAjaxSource": "lib/datatables/server_campaigns.php",
