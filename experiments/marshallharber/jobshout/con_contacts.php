...
require_once("../../constants.php");
	 ...
	 */
	$aColumns = array('Name','Email','Telephone','DateRegistered','GUID');
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		for ( $i=0 ; $i<count($aColumns) ; $i++ )
		{
			...
			elseif ($aColumns[$i] == "PostedTimestamp" || $aColumns[$i] == "Modified") {
		...
		*/
		...
		$row[] = '<a href="contact.php?GUID='.$curr_id.'" title="Edit this job" ><i class="splashy-pencil"></i><a>';
		$row[]= '<a href="delete_contact.php?GUID='.$curr_id.'" title="Delete this job" onClick="return confirm(\'Are you sure to delete\');"><i class="splashy-error_x"></i><a>';
