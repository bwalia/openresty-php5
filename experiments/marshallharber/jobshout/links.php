...
require_once('include/main-header.php'); ?>
	...
	<ul>
		...
		<?php
					...
					?>
		<li>
			<a href="link.php">Add new Link</a>
		</li>
		<?php }?>
					...
					dt_e: function(){
						if($('#dt_e').length) {
							...
							oTable = $('#dt_e').dataTable( {
								...
								<?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['links']) && isset($_SESSION['last_search']['links']['sSearch'])) { ?>
								"oSearch": {"sSearch": "<?php  echo $_SESSION['last_search']['links']['sSearch'];  ?>"},
								<?php } ?>
								"bProcessing": true,
								"bServerSide": true,
								"iDisplayLength": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['links']) && isset($_SESSION['last_search']['links']['iDisplayLength'])) { echo $_SESSION['last_search']['links']['iDisplayLength']; } else { echo '25'; } ?>,
								"iDisplayStart": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['links']) && isset($_SESSION['last_search']['links']['iDisplayStart'])) { echo $_SESSION['last_search']['links']['iDisplayStart']; } else { echo '0'; } ?>,
								...
								"sAjaxSource": "lib/datatables/server_links.php",
