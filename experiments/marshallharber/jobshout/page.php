									...
									<div class="form-horizontal well">
										<fieldset>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" class="span10 code" name="Code" id="Code" <?php if($auto_format!=0) { ?> readonly="readonly" <?php } ?> value="<?php echo $Code;?>" onChange="format_manual_code('Code')" />
												...
												<div class="form-horizontal well">
													<fieldset>
														<div class="control-group">
															...
															<div class="controls">
																<input type="text" class="span10 code" name="obj_code_<?php echo $obj_id;?>" id="obj_code_<?php echo $obj_id;?>" value="<?php echo $obj_code;?>" <?php if($obj_auto_format==1) { ?> readonly="readonly" <?php } ?> onChange="format_manual_code('obj_code_<?php echo $obj_id;?>')" />
																<span class="help-block">
									...
									<div class="form-horizontal well">
										<fieldset>
											...
											<div class="control-group">
												...
												<label class="control-label">Code</label>
															<div class="controls">
																<input type="text" class="span10 code" name="obj_code_nw" id="obj_code_nw" value="" readonly="readonly" onChange="format_manual_code('obj_code_nw')" />
																<span class="help-block">
