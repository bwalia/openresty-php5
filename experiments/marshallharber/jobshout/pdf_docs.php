...
require_once('include/main-header.php'); ?>
	...
	<ul>
		...
		<?php
					...
					?>
		<li>
			<a href="pdf_doc.php"> Add new PDF Document</a>
		</li>
		<?php }?>
					...
					job_apps: function(){
						if($('#job_apps').length) {
							...
							oTable = $('#job_apps').dataTable( {
								<?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['pdf_docs']) && isset($_SESSION['last_search']['pdf_docs']['sSearch'])) { ?>
								"oSearch": {"sSearch": "<?php  echo $_SESSION['last_search']['pdf_docs']['sSearch'];  ?>"},
								<?php } ?>
								"bProcessing": true,
								"bServerSide": true,
								"iDisplayLength": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['pdf_docs']) && isset($_SESSION['last_search']['pdf_docs']['iDisplayLength'])) { echo $_SESSION['last_search']['pdf_docs']['iDisplayLength']; } else { echo '25'; } ?>,
								"iDisplayStart": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['pdf_docs']) && isset($_SESSION['last_search']['pdf_docs']['iDisplayStart'])) { echo $_SESSION['last_search']['pdf_docs']['iDisplayStart']; } else { echo '0'; } ?>,
								...
								"sAjaxSource": "lib/datatables/server_pdfdocs.php",
