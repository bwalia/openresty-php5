...
{ 
	...
	//echo "update categorygroups set SiteID='".$site_id."', Modified='$time', Name='$Name',Code='$CODE',Active='$Active',UserID='$user_id',Sync_Modified='$Sync_Modified',Type='$Type', Auto_Format=$Auto_Format where GUID='$guid'";
	 ...
	 if($db->query("update categorygroups set SiteID='".$site_id."', Modified='$time', Name='$Name',Code='$CODE',Active='$Active',UserID='$user_id',Type='$Type', Auto_Format=$Auto_Format, access_level_num= $access_level_num, Site_GUID= '$site_guid', User_GUID= '$user_guid' where GUID='$guid'")){
	 ...
	 //$db->debug();
		...
		$GUID=UniqueGuid('categorygroups', 'GUID');	
		 if($db->query("INSERT INTO categorygroups (GUID,Created,Modified,SiteID,Name,Code,Active,UserID,Type,Auto_Format,access_level_num, Site_GUID, User_GUID) VALUES ('$GUID','$time','$time','".$site_id."','$Name','$CODE','$Active','$user_id','$Type',$Auto_Format,$access_level_num, '$site_guid', '$user_guid')")){
