		...
		<div id="maincontainer" class="clearfix">
			...
			<script>
				...
				gebo_charts = {
						...
						var data = [
						<?php 
						$RefererSites = $db->get_Results("SELECT * FROM logfile where RefererSite!='jobshout' AND RefererSite!=''  ");
						foreach($RefererSites as $search){
						$query = $db->get_var("SELECT COUNT(*) as num FROM logfile where Referer like '%$search->RefererSite%'  or RefererSite like '%$search->RefererSite%' or Url like '%$search->RefererSite%'");
							?>	
							{
								label: <?php echo $search->RefererSite; ?>,
								data: <?php echo $query;?>
							},
						<?php } ?>
