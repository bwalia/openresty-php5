...
require_once("lib.inc.php");
	...
	$set_session= set_session_values('pictures',$sSearch,$iDisplayStart,$iDisplayLength);
	 ...
	 */
	 $aColumns = array('pictures.ID','sites.Name as SiteName','pictures.Name','pictures.Code', 'pictures.Picture', 'pictures.Type', 'pictures.Modified','pictures.Status', 'documents.Document','pictures.GUID');
	 
	$aColumns1 = array('ID', 'SiteName', 'Name', 'Code', 'Picture', 'Type', 'Modified', 'Status', 'Document', 'GUID');
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "pictures.GUID";
	
	/* DB table to use */
	$sTable = "pictures left outer join documents on pictures.DocumentID=documents.ID left outer join sites on pictures.SiteID=sites.ID";
