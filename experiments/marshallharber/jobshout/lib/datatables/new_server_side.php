...
require_once("../../constants.php");
	 ...
	 */
	$aColumns = array('UserID','PageTitle', 'Reference', 'Modified','PostedTimestamp','GUID');
	 ...
	 */
	$sWhere = "WHERE SiteID='".SITE_ID."' and Type='job'";
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		$row[] = '<a href="delete-page.php?GUID='.$curr_id.'" id="delete">Delete<a>';
		$row['extra'] = 'hrmll';
		$output['aaData'][] = $row;
	}
