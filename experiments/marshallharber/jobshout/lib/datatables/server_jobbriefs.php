...
require_once("lib.inc.php");
	...
	$set_session= set_session_values('jobbriefs',$sSearch,$iDisplayStart,$iDisplayLength);
	 ...
	 */
	 $aColumns = array('jobbriefs.GUID','jobbriefs.ID','sites.Name as SiteName','jobbriefs.Name','jobbriefs.Email','jobbriefs.Mobile','jobbriefs.Modified','jobbriefs.JobBriefFileName');
	$aColumns1 = array('GUID','ID','SiteName','Name','Email','Mobile','Modified','JobBriefFileName');
