...
require_once("lib.inc.php");
	 ...
	 */
	$aColumns = array('contacts.Name','contacts.Email','contacts.Telephone','contacts.zStatus','contacts.DateRegistered','contacts.Modified','sites.Name as SiteName','contacts.ID'); 
	 
	$aColumns1 = array('Name','Email','Telephone','zStatus','DateRegistered','Modified','SiteName','ID');
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		for ( $i=0 ; $i<count($aColumns1) ; $i++ )
		{
			...
			elseif ($aColumns1[$i] == "DateRegistered") {
