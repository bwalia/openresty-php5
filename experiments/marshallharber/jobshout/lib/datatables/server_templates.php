...
require_once("lib.inc.php");
	...
	$set_session= set_session_values('templates',$sSearch,$iDisplayStart,$iDisplayLength);
	 ...
	 */
	 ...
	 {
		$sWhere = "WHERE templates.SiteID in ('".$_SESSION['site_id']."') and templates.Type=0";
	}
	else
	{
		$sWhere = "WHERE templates.Type=0";
	}
...
if($user_access_level>1) {
		$row[] = '<a href="template.php?GUID='.$curr_id.'" title="Edit this template" ><i class="splashy-pencil"></i><a>';
		$row[]= '<a href="delete-template.php?GUID='.$curr_id.'" title="Delete this template" onClick="return confirm(\'Are you sure to delete\');"><i class="splashy-remove"></i><a>';
		}
		else
		{
