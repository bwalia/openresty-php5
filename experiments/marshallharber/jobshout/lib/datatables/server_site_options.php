...
require_once("lib.inc.php");
	 ...
	 */
	$aColumns = array('sites.Name', 'site_options.name', 'site_options.LastModified', 'site_options.status', 'site_options.json_object_data', 'site_options.GUID');
	
	$aColumns1 = array('Name', 'name', 'LastModified', 'status', 'json_object_data', 'GUID');
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		{
			$smtp=false;
			if ($aColumns1[$i] == "json_object_data") {
				$smtp=true;
			}
...
if($user_access_level>1) {
				...
				$row[] = '<a href="site_detail.php?GUID='.$aRow[ $aColumns1[$i] ].'" title="Edit this option" ><i class="splashy-pencil"></i><a>';
				}
