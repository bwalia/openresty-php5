					...
					dt_e: function(){
						if($('#dt_e').length) {
							...
							oTable = $('#dt_e').dataTable( {
								"oSearch": {"sSearch": "<?php if(isset($_GET['srch']) && $_GET['srch']!='') { echo $_GET['srch']; } elseif(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['categories']) && isset($_SESSION['last_search']['categories']['sSearch'])) { echo $_SESSION['last_search']['categories']['sSearch']; } ?>"},
							
								"bProcessing": true,
								"bServerSide": true,
								"iDisplayLength": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['categories']) && isset($_SESSION['last_search']['categories']['iDisplayLength'])) { echo $_SESSION['last_search']['categories']['iDisplayLength']; } else { echo '25'; } ?>,
								"iDisplayStart": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['categories']) && isset($_SESSION['last_search']['categories']['iDisplayStart'])) { echo $_SESSION['last_search']['categories']['iDisplayStart']; } else { echo '0'; } ?>,
								...
								"sAjaxSource": "lib/datatables/server_categories.php",
