...
<input type="hidden" value="<?php if($guid!='') { echo $guid; } else { $Guid = NewGuid();
									echo $Guid; } ?>" name="GUID" id="GUID" class="textbox">
									...
									<div class="row-fluid">
										<div class="span8">
											...
											<select onChange="" name="serverType">
												<option value="">-- Select --</option>
												<option <?php if($Type == 'Nginx') { echo "selected"; } ?> value="page">Nginx</option>
												<option <?php if($Type == 'Apache') { echo "selected"; } ?> value="product">Apache</option>
												<option <?php if($Type == 'IIS') { echo "selected"; } ?> value="job">IIS</option>
											</select>
										</div>
									</div>
								</div>
								...
								<div class="formSep">
									<div class="row-fluid">
										<div class="span4">
											...
											<input type="text" name="stagingRootDir" class="span12" id="stagingRootDir" value=""/>
										</div>
									</div>
								</div>
								<div class="formSep">
									<div class="row-fluid">
										...
										<div class="span4">
											...
											<input type="text" name="buildNumber" class="span12" id="buildNumber" value=""/>
										</div>
									</div>
								</div>
