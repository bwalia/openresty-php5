...
<?php echo $select_cats; ?>
			...
			function generate_metatags(){
				...
				if(status!=true){
					...
					// var	jsonRow= "document_name="+document_name+"&body="+body+"&category1="+category1+"&category2="+category2+"&category3="+category3+"&category4="+category4+"&category5="+category5+"&category6="+category6+"&site_id="+site+"&location="+location;
					$.ajax({                
						type: "POST",
						url: "check_metaData.php",
