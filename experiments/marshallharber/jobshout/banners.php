...
require_once('include/main-header.php'); ?>
	...
	<ul>
		...
		<?php
					...
					?>
		<li>
			<a href="banner.php">Add new Banner</a>
		</li>
		<?php }?>
					...
					dt_e: function(){
						if($('#dt_e').length) {
							...
							oTable = $('#dt_e').dataTable( {
								<?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['banners']) && isset($_SESSION['last_search']['banners']['sSearch'])) { ?>
								"oSearch": {"sSearch": "<?php  echo $_SESSION['last_search']['banners']['sSearch'];  ?>"},
								<?php } ?>
								"bProcessing": true,
								"bServerSide": true,
								"iDisplayLength": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['banners']) && isset($_SESSION['last_search']['banners']['iDisplayLength'])) { echo $_SESSION['last_search']['banners']['iDisplayLength']; } else { echo '25'; } ?>,
								"iDisplayStart": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['banners']) && isset($_SESSION['last_search']['banners']['iDisplayStart'])) { echo $_SESSION['last_search']['banners']['iDisplayStart']; } else { echo '0'; } ?>,
								...
								"sAjaxSource": "lib/datatables/server_banners.php",
