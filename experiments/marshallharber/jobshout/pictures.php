...
require_once('include/main-header.php'); ?>
	...
	<ul>
		...
		<?php
					...
					?>
		<li>
			<a href="picture.php">Add new Picture</a>
		</li>
		<?php }?>
					...
					dt_e: function(){
						if($('#dt_e').length) {
							...
							oTable = $('#dt_e').dataTable( {
								<?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['pictures']) && isset($_SESSION['last_search']['pictures']['sSearch'])) { ?>
								"oSearch": {"sSearch": "<?php  echo $_SESSION['last_search']['pictures']['sSearch'];  ?>"},
								<?php } ?>
								"bProcessing": true,
								"bServerSide": true,
								"iDisplayLength": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['pictures']) && isset($_SESSION['last_search']['pictures']['iDisplayLength'])) { echo $_SESSION['last_search']['pictures']['iDisplayLength']; } else { echo '25'; } ?>,
								"iDisplayStart": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['pictures']) && isset($_SESSION['last_search']['pictures']['iDisplayStart'])) { echo $_SESSION['last_search']['pictures']['iDisplayStart']; } else { echo '0'; } ?>,
								...
								"sAjaxSource": "lib/datatables/server_pictures.php",
