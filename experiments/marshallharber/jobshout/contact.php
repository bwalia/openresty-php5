		 ...
		 if($_FILES['fileinput']['size'] > 0)
		  ...
		  if($site_id==29201){
			if($update && $update_pic){
				...
				$WM_Email = WEBMASTER_EMAIL;
				$WM_Name = WEBMASTER_NAME;
...
if(!isset($_GET['GUID']) && $insert && $update_pic) {
 ...
 if(isset($_GET['GUID'])){
	          ...
	          $user3 = $db->get_row("SELECT *  FROM contacts where  GUID = '".$_GET['GUID']."'");
									...
									<div class="form-horizontal well">
										...
										<div class="control-group">
											...
											<label class="radio inline">
												<input type="radio" value="m" name="gender" <?php if($gender == 'm') { echo ' checked'; } ?>/>
												Male
											</label>
											<label class="radio inline">
