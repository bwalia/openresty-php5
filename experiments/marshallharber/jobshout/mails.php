	...
	<ul>
		...
		<li>
		 ...
		 <?php
					...
					?>
		<li>
			<a href="mail.php">Add new Mailing List</a>
		</li>
		<?php } ?>
					...
					dt_e: function(){
						if($('#dt_e').length) {
							...
							oTable = $('#dt_e').dataTable( {
								<?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['wi_mailinglists']) && isset($_SESSION['last_search']['wi_mailinglists']['sSearch'])) { ?>
								"oSearch": {"sSearch": "<?php  echo $_SESSION['last_search']['wi_mailinglists']['sSearch'];  ?>"},
								<?php } ?>
								"bProcessing": true,
								"bServerSide": true,
								"iDisplayLength": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['wi_mailinglists']) && isset($_SESSION['last_search']['wi_mailinglists']['iDisplayLength'])) { echo $_SESSION['last_search']['wi_mailinglists']['iDisplayLength']; } else { echo '25'; } ?>,
								"iDisplayStart": <?php if(isset($_SESSION['last_search']) && isset($_SESSION['last_search']['wi_mailinglists']) && isset($_SESSION['last_search']['wi_mailinglists']['iDisplayStart'])) { echo $_SESSION['last_search']['wi_mailinglists']['iDisplayStart']; } else { echo '0'; } ?>,
								...
								"sAjaxSource": "lib/datatables/server_mails.php",
