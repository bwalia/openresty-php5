...
{ 
	...
	/*
	echo "INSERT INTO categories (GUID,Created,Modified,SiteID,Name,Code,CategoryGroupID,Active,UserID,Type,Sync_Modified) VALUES (NOW(),NOW(),'".SITE_ID."','$name','$Code','$category_gropuID','$status','$userID','$reg_type','$Sync_Modified','$GUID')";*/
	
	
	
	
	 $db->query("INSERT INTO categories (GUID,Created,Modified,SiteID,Name,Code,CategoryGroupID,Active,UserID,Type,Sync_Modified) VALUES ('$GUID','$time','$time','".SITE_ID."','$Name','$CODE','$category_gropuID','$Active','$user_id','$reg_type','$Sync_Modified')");
	// $db->debug();
		...
		<div id="maincontainer" class="clearfix">
            ...
            <div id="contentwrapper">
                <div class="main_content">
                    ...
                    <div><a href="categories.php">Back to listing</a></div><br/><br/>
                    <div class="row-fluid">
